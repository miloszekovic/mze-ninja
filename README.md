...
## TODO
## 1 - content
## 2 - sredjivanje index.html strane
## 3 - title tag
## 4 - responsive code
## 5 - animacije i tranzicije stranica i komponenata
## 6 - content from JSON (local or from GitHub)
## 7 - namestiti infinitiv skrol/loader radova u portfolio 
