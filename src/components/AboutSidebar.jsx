  ...
  render() {
    return (
        <article className="sidebar">
            ...
            <p>HTML5 - CSS3 - Sass/LESS<br />JavaScript - jQuery - jQuery Mobile<br />React - VUE - Gulp<br />GIT/SVN - UX/UI<br />Web Design - Responsive Design<br />Atomic Design Methodology<br />Material Design<br />Progressive Enhancement<br />Pixel Perfect Layouts<br />From PSD to HTML - SEO<br />WordPress - Joomla - Magento</p>
            <h4>Dev and design tools</h4>
            <p>Visual Studio<br />Visual Studio Code<br />Sketch<br />Adobe CC</p>
        </article>
    );
  }
}
