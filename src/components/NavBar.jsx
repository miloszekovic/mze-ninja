...
import IconHomeLightActive from '../assets/img/ui/icon-home-light-active.svg'
import IconAbout from '../assets/img/ui/icon-about.svg'
import IconAboutActive from '../assets/img/ui/icon-about-active.svg'
import IconAboutLightActive from '../assets/img/ui/icon-about-light-active.svg'
...
import IconPortfolioLightActive from '../assets/img/ui/icon-portfolio-light-active.svg'
...
import IconContactLightActive from '../assets/img/ui/icon-contact-light-active.svg'
          ...
          <ul>
            <li>
              <NavLink to="/" exact activeClassName="active">
                ...
                <div className="nav--button-light-active"><img src={IconHomeLightActive} alt="Miloš Zeković - Front-end developer / UX/UI designer" /></div>
              </NavLink>
            </li>
            <li>
              <NavLink to="/about" exact activeClassName="active">
                ...
                <div className="nav--button-light-active"><img src={IconAboutLightActive} alt="Miloš Zeković - About me" /></div>
              </NavLink>
            </li>
            <li>
              <NavLink to="/portfolio" exact activeClassName="active">
                ...
                <div className="nav--button-light-active"><img src={IconPortfolioLightActive} alt="Miloš Zeković - Portfolio" /></div>
              </NavLink>
            </li>
            <li>
              <NavLink to="/contact" exact activeClassName="active">
                ...
                <div className="nav--button-light-active"><img src={IconContactLightActive} alt="Miloš Zeković - Contact" /></div>
              </NavLink>
            </li>
          </ul>
        </nav>
